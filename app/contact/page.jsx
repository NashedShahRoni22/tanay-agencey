        ...
        >
          ...
          <div className="lg:col-span-5 p-6 sm:p-10 md:p-14 flex flex-col justify-between lg:border-r border-white/10 bg-white/5 lg:bg-transparent">
            <div>
              <motion.div variants={itemVars} className="flex items-center gap-3 mb-6">
                ...
                <span className="text-white/80 text-xs font-bold tracking-widest uppercase">Our team is online</span>
              </motion.div>
              
              <motion.h1 variants={itemVars} className="text-3xl md:text-5xl font-bold text-white mb-4 leading-tight">
                Let’s talk about your <span className="text-white/60">idea.</span>
              </motion.h1>
              
              <motion.p variants={itemVars} className="text-white/70 text-base md:text-lg mb-10 leading-relaxed">
                Need help with pricing or features? Our team is here to guide you.
              </motion.p>

              <motion.div variants={itemVars} className="space-y-6 md:space-y-8">
                <div className="flex items-center gap-4">
                  ...
                  <div className="min-w-0">
                    <h4 className="text-white font-semibold text-sm md:text-base">Email Us</h4>
                    <p className="text-white/60 text-sm md:text-base truncate">hello@yourcompany.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="text-white font-semibold text-sm md:text-base">Office</h4>
                    <p className="text-white/60 text-sm md:text-base leading-snug">Silicon Valley, CA</p>
                  </div>
                </div>
              </motion.div>
            </div>

            <motion.div variants={itemVars} className="pt-8 border-t border-white/10 mt-10 flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="lg:col-span-7 p-6 sm:p-10 md:p-14 bg-white">
            <motion.div variants={itemVars} className="mb-8 md:mb-10">
              ...
              <p className="text-gray-500 text-sm md:text-base font-medium">We typically reply within a few hours.</p>
            </motion.div>

            <motion.form variants={containerVars} className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              <motion.div variants={itemVars} className="space-y-1.5 col-span-1">
              ...
              <motion.div variants={itemVars} className="space-y-1.5 col-span-1">
                <label className="text-xs font-bold text-gray-700 ml-1 uppercase">Work Email</label>
                <input 
                  type="email" 
              ...
              <motion.div variants={itemVars} className="space-y-1.5 col-span-full">
                <label className="text-xs font-bold text-gray-700 ml-1 uppercase">Subject</label>
                <input 
                  type="text" 
              ...
              <motion.div variants={itemVars} className="space-y-1.5 col-span-full">
                <label className="text-xs font-bold text-gray-700 ml-1 uppercase">Message</label>
                <textarea 
                  rows={4}
